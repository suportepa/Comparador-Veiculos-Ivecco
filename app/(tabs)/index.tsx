...
=======
    ...
    TouchableOpacity,
    Dimensions,
>>>>>>> 31fc39898493dedb826e4e17a8d6e80b9741f89d
} from 'react-native';
...
=======
        ...
        // Tenta extrair apenas números para uma comparação numérica
        const num1 = parseFloat(val1.replace(/[^\d.]/g, ''));
        const num2 = parseFloat(val2.replace(/[^\d.]/g, ''));
>>>>>>> 31fc39898493dedb826e4e17a8d6e80b9741f89d
...
=======
    ...
    const ResumeComponent: React.FC<{ veiculo: Veiculo }> = ({ veiculo }) => (
        <View style={styles.resumeBox}>
            <Text style={styles.resumeTitle}>Resumo da Vantagem</Text>
            <Text style={styles.resumeText}>
                {/* Remove a formatação markdown e capitaliza (se necessário) */}
                {veiculo.resumoVantagem.replace(/\*\*(.*?)\*\*/g, (match: string, p1: string) => p1.toUpperCase())}
            </Text>
>>>>>>> 31fc39898493dedb826e4e17a8d6e80b9741f89d
        </View>
...
>>>>>>> 31fc39898493dedb826e4e17a8d6e80b9741f89d
                ...
                {specsKeys.map((key) => {
                    ...
                    // Formata a chave para uma label mais legível (ex: 'pesoEmOrdemDeMarcha' -> 'PESO EM ORDEM DE MARCHA')
...
>>>>>>> 31fc39898493dedb826e4e17a8d6e80b9741f89d
    ...
    // Lógica de Padronização da Imagem (CORRIGIDA)
    const imageSourceA = typeof veiculoA.imagem === 'number' ? veiculoA.imagem : { uri: veiculoA.imagem };
    const imageSourceB = typeof veiculoB.imagem === 'number' ? veiculoB.imagem : { uri: veiculoB.imagem };
...
>>>>>>> 31fc39898493dedb826e4e17a8d6e80b9741f89d
                ...
                <View style={styles.imageRow}>
                    <Image
                        source={imageSourceA} // CORRIGIDO
                        style={styles.vehicleImage}
                        resizeMode="cover"
                    />
                    <Text style={styles.vsText}>VS</Text>
                    <Image
                        source={imageSourceB} // CORRIGIDO
                        style={styles.vehicleImage}
                        resizeMode="cover"
                    />
                </View>
